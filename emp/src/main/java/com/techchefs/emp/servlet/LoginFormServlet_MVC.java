...
@WebServlet("/loginNew")
public class LoginFormServlet_MVC extends HttpServlet {
//	@Override
//	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
//		req.getRequestDispatcher("../LoginPageMVC.jsp").forward(req, resp);
//	}
...
//					out.print("<p style=\"text-align:center,color:red;\">Invalid Credentials</p>");
			// req.getRequestDispatcher("/loginFail?msg=Invalid Credentials").forward(req,
			// resp);
			req.getRequestDispatcher("/loginJSP?msg=Invalid Credentials").forward(req, resp);
		}
	}
